...
/**
 * Class Customer_Has_Ordered_Product_Categories_Before
 *
 * This class defines a rule to check if a customer has ordered specific products before.
 *
 * @since 1.0.0
 * @version 1.0.0
 * @author Rehan Adil
 ...
 */
class Customer_Has_Ordered_Product_Categories_Before extends Rule_Base
{
	/**
	...
	{
		// Add the 'Customer_Has_Ordered_Product_Before' rule to the rules array.
