...
class Qualifier
{
	...
	public function load_rules()
	{
		$default_rules = apply_filters( 'swift-coupons/qualifier-default-rules', [ 
			...
			'Custom_Taxonomy_Exists_In_Cart'                 => '\Sreshto\SwiftCoupons\Qualifier\Rule\Custom_Taxonomy_Exists_In_Cart',
			'Customer_Has_Ordered_Product_Categories_Before' => '\Sreshto\SwiftCoupons\Qualifier\Rule\Customer_Has_Ordered_Product_Categories_Before',
			'Customer_Has_Ordered_Products_Before'           => '\Sreshto\SwiftCoupons\Qualifier\Rule\Customer_Has_Ordered_Products_Before',
			...
			'Customer_Total_Spent_On_A_Category'             => '\Sreshto\SwiftCoupons\Qualifier\Rule\Customer_Total_Spent_On_A_Category',
